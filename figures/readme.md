...
![month_arrival_delay.png](https://github.com/Pandas-UFT/Pandas/blob/master/figures/month_arrival_delay.png)

### Airlines
The airlies AS, and HA have almost no delays, while the rest have an average 7 minute delay. 

![airline_departure_delay.png](https://github.com/Pandas-UFT/Pandas/blob/master/figures/airline_departure_delay.png)

![airline_arrival_delay.png](https://github.com/Pandas-UFT/Pandas/blob/master/figures/airline_arrival_delay.png)
...
![time_departure_delay.png](https://github.com/Pandas-UFT/Pandas/blob/master/figures/time_departure_delay.png)

![time_arrival_delay.png](https://github.com/Pandas-UFT/Pandas/blob/master/figures/time_arrival_delay.png)
